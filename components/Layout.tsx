      ...
      <header className="sticky top-0 bg-white/80 backdrop-blur-md border-b border-slate-100 z-[100] transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a 
              href="tel:+905075199429" 
              target="_blank"
              rel="noopener noreferrer"
              className="hidden lg:flex items-center gap-2 text-slate-500 hover:text-slate-900 transition-colors mr-4"
            >
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Destek:</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                ...
                <a 
                  href="#referanslar" 
                  onClick={(e) => scrollToSection(e, 'referanslar')}
      ...
      <footer className="bg-slate-50 border-t border-slate-100 py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest mb-6">Hızlı Menü</h4>
              <ul className="space-y-4 text-sm text-slate-500 font-medium">
                <li><a href="#calculator" onClick={(e) => scrollToSection(e, 'calculator')} className="hover:text-orange-500 transition-colors">Fiyat Hesapla</a></li>
                <li><a href="#referanslar" onClick={(e) => scrollToSection(e, 'referanslar')} className="hover:text-orange-500 transition-colors">Referanslar</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest mb-6">İletişim</h4>
              <ul className="space-y-4 text-sm text-slate-500 font-medium">
                <li><a href="tel:+905075199429" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition-colors">+90 (507) 519 94 29</a></li>
                <li><span className="text-slate-400">İstanbul, Türkiye</span></li>
              </ul>
            </div>
          </div>
